export default function NoteItem({ note, onEdit, onDelete }) {
  ...
  return (
    <article
      ...
      className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-400 dark:border-slate-700 dark:bg-slate-950 dark:shadow-slate-950/20 cursor-pointer"
    >
